...
export async function decryptPrompt(
  ...
  const labelStatus =()=>{
    if(attempt >= 3) return `Si no recuerdas tu contraseña tendras que borrar '${generatedFileName}' y dejar que el programa cree el archivo.`
