 ...
 */
export class  ServiceLoginFieldsSchema extends ZodSchemaManager<"0.0.0",typeof ServiceLoginFieldsSchema> implements SchemaUtilities {
  static "0.0.0" = z.object({
    username: z.string().nullable().default(null),
    password: z.string().nullable().default(null),
    aliasRef: StoredPaymentMethodManager.getLastSchema().pick({uuid:true}).shape.uuid.nullable().default(null)
  })
